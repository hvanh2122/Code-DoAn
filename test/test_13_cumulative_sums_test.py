...
def cumulative_sums_test(input):
    n= len(input)
    # Step 1
    ...
    return success, [p_forward, p_backward]


if __name__ == "__main__":
    bits = '10101110100101010001010101010010101110100101'
    success, plist = cumulative_sums_test(bits)
